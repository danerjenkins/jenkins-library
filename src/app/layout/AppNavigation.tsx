...
export function AppNavigation({ addBookPath }: AppNavigationProps) {
      ...
      <nav className="mobile-bottom-nav" aria-label="Mobile navigation">
        ...
        <div className="mobile-bottom-nav__more-shell" ref={mobileMoreRef}>
          <button
            ...
            onClick={() => setMoreOpen((current) => !current)}
          >
            <MoreHorizontal aria-hidden="true" size={18} className="app-nav__icon" />
            <span className="app-nav__label">More</span>
            <ChevronDown aria-hidden="true" size={16} className="app-more__caret" />
          </button>
          {moreOpen ? (
            <div
